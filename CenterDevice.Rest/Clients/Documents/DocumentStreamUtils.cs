...
namespace CenterDevice.Rest.Clients.Documents
{
    internal static class DocumentStreamUtils
    {
        ...
        internal static void AddFileToUpload(IRestRequest uploadRequest, string fileName, string filePath, StreamWrapper streamWrapper, CancellationToken cancellationToken)
        {
        ...
        internal static Stream WrapUploadStream(Stream stream, StreamWrapper streamWrapper)
        {
            return streamWrapper?.WrapUploadStream(stream) ?? stream;
        }

        internal static Stream WrapDownloadStream(Stream stream, StreamWrapper streamWrapper)
        {
