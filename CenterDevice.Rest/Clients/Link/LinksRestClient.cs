...
namespace CenterDevice.Rest.Clients.Link
{
    ...
    {
        private const string URI_RESOURCE = "v2/links";

        [Inject]
        public LinksRestClient(IOAuthInfoProvider oauthInfo, IRestClientConfiguration configuration, IRestClientErrorHandler errorHandler) : base(oauthInfo, configuration, errorHandler)
        {
        }
