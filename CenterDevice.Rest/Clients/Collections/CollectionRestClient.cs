...
namespace CenterDevice.Rest.Clients.Collections
{
    ...
    {
        private const string URI_RESOURCE = "v2/collection";

        public CollectionRestClient(IOAuthInfoProvider oauthInfo, IRestClientConfiguration configuration, IRestClientErrorHandler errorHandler) : base(oauthInfo, configuration, errorHandler) { }
