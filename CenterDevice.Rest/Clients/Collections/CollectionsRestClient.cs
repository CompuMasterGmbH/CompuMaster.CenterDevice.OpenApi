...
namespace CenterDevice.Rest.Clients.Collections
{
    ...
    {
        private const string URI_RESOURCE = "v2/collections";

        public CollectionsRestClient(IOAuthInfoProvider oauthInfoProvider, IRestClientConfiguration configuration, IRestClientErrorHandler errorHandler) : base(oauthInfoProvider, configuration, errorHandler) { }
