...
namespace CenterDevice.Rest.Clients.Folders
{
    ...
    {
        private const string URI_RESOURCE = "v2/folder/";

        public FolderRestClient(IOAuthInfoProvider oauthInfoProvider, IRestClientConfiguration configuration, IRestClientErrorHandler errorHandler) : base(oauthInfoProvider, configuration, errorHandler) { }
