...
namespace CenterDevice.Rest.Clients.Tenant
{
    ...
    {
        private const string URI_RESOURCE = "v2/tenant/{0}/features";

        public TenantFeaturesRestClient(IOAuthInfoProvider oauthInfo, IRestClientConfiguration configuration, IRestClientErrorHandler errorHandler) : base(oauthInfo, configuration, errorHandler)
        {
        }
